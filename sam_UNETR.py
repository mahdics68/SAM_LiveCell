...
if __name__ == "__main__":
    ...
    #--train --cell_type "MCF7" --input /scratch-grete/projects/nim00007/data/LiveCELL/ --save_root /scratch-grete/usr/nimmahen/models/UNETR/sam/checkpoints/livecell_MCF7_10_vit_b --iterations 10000 --checkpoint /scratch-grete/usr/nimmahen/models/SAM/checkpoints/sam_vit_b_01ec64.pth --backbone "sam" --encoder "vit_b" --use_sam_stats --n_samples 10
